...
fn main() {
    ...
    let mut client =
        Client::connect("postgresql://attila:Rh-Tmr4dGHjIsVnDFBpRGQ@free-tier13.aws-eu-central-1.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full&options=--cluster%3Dtamer-grebe-3007", connector).unwrap();
